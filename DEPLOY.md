...
# Секрет для подписи cookie-сессии админки — сгенерировать свой для прода:
#   openssl rand -base64 32
AUTH_SECRET="<сгенерировать-свой>"

# Email единственного админа (пароль — bcrypt-хеш захардкожен в lib/auth.ts,
# не хранится в .env: bcrypt-хеши всегда начинаются с "$2b$10$...", а
# встроенный в Next.js загрузчик .env делает $VAR-подстановку и portит хеш).
