...
export default function WhyChooseUs({ content, as: Heading = "h2" }: WhyChooseUsProps) {
  return (
    <section className="px-4 py-10 sm:px-6 sm:py-14 lg:px-10">
      <div className="mx-auto mb-8 max-w-200 sm:mb-10">
        ...
        <Heading className="mb-4 text-2xl font-extrabold text-ink sm:text-[30px]">{content.title}</Heading>
        <p className="max-w-160 text-sm leading-relaxed text-muted sm:text-base">{content.description}</p>
      </div>
